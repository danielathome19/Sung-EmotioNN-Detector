...
if __name__ == '__main__':
    ...
    # separatevocals('SongTest/Erlkonig.wav', 'naErlkonig')
    ...
    # predict('SongTest/Erlkonig/')
    predict('SongTest/ErlkonigTen/')
    predict('SongTest/ErlkonigUnsplitTen/')
    # predict('SongTest/ErlkonigUnsplit/')
